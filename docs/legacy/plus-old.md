...
::: warning 最新动态 2024-11-28

- ChatGPT Plus 拼车服务 **汉Plus，宋Plus，元Plus** 停服下线；
- 照例还有小作文：[ChatGPT 王朝车队退役，Claude 海洋车队准备集合！](https://mp.weixin.qq.com/s/86gIAXeJWNh56eqUbvtQDg)
...
简单说就是国内可以直接访问的 Chatgpt Plus 官方镜像。
...
因此，这个服务方便没账号或者无法订阅Plus的朋友们，以相对低的价格在国内直接使用官方的Chatgpt Plus 服务。
...
1. 打开[ChatGPT拼车服务站点](https://station.aiporters.com/)，你将看到这样一个页面：

![plus-station.png](plus-old/plus-station.png)

2. 找一辆还没满员的乘客，这里我们以汉 Plus举例说明：

打开[汉 Plus](https://hanplus.aiporters.com/)，你将看到这样一个页面：

![plus-login.png](plus-old/plus-login.png)
...
![plus-login1.png](plus-old/plus-login1.png)

通过验证之后，你就会进入这个跟官方无限接近的页面，畅享官方服务：

![plus-office.png](plus-old/plus-office.png)
...
![plus-shop.png](plus-old/plus-shop.png)
...
![plus-user.png](plus-old/plus-user.png)
...
![voice-entry.jpg](plus-old/voice-entry.png)

![voice.jpg](plus-old/voice.png)
...
![gpt4-limit.png](plus-old/gpt4-limit.png)
...
![status.png](plus-old/status.png)
...
![image.png](plus-old/pay-fail.png)

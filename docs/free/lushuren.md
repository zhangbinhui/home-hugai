...
✨鲁树人GPT 使用 gpt-4，现在可以通过Google搜索信息，使用DallE 3画图，gpt-4v读图，用LinkReader解析网页，从维基百科获取信息，甚至是编写Python代码。
...
比如最近忙里偷闲，根据身边用户的真实反馈，给鲁树人GPT新增了三个专职小助理：

1. 论文专家：一位卓越的研究文章撰写家，可以根据提供的概要一步步完整地实现用户的论文。

2. bilibili助理：为您推荐热门视频，搜索视频，以及针对视频内容提供问答支持。

3. 股票分析师：股票分析专家，给用户提供专业的股票市场分析、投资建议和风险评估。

...
<iframe src="https://lushuren.hugai.top/video/lushuren-demo.mp4" allow="fullscreen" allowfullscreen="" width="560" height="315" style="border:0"></iframe>
...
猜测很可能是信使1天内的调用次数超限了，目前没有官方文档说明。

后面会考虑增加多个信使轮流传递消息，等我研究好怎么实现再更新吧。
